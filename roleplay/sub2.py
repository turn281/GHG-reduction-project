...
def yearlyOperationFunc(fleetAll,numCompany,pureDi,startYear,elapsedYear,NShipFleet,Alpha,tOpSch,v,valueDict,parameterFile4):
    NumFleet = len(fleetAll[numCompany])
    ...
    Di = fleetAll[numCompany]['total']['overDi'][elapsedYear] + pureDi
    ...
    if Di <= valueDict["rDMax"]*maxCta and Di / maxCta > 0.0:
        ...
        fleetAll[numCompany]['total']['overDi'][elapsedYear] = Di - valueDict["rDMax"]*maxCta
    else:
